...
entry_read_200 = openapi.Response('Entry is marked as read', EntryDetailSerializer)
entry_read_201 = openapi.Response('Entry was already marked as read', EntryDetailSerializer)
